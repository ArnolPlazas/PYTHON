...
#Â¿CÃ³mo lo haremos?, usaremos una variable para guardar el resultado del cálculo de
...
estatura = float(input("Cuentame mas de ti, para agregarlo a tu perfil. ¿Cuánto mides? Dámelo en metros. "))
estatura_m = int(estatura)
estatura_cm = int( (estatura - estatura_m)*100 )
print()
#Cuarta interacción. Consultamos cuántos amigos tiene el usuario.
num_amigos = int(input("Muy bien. Finalmente, cuántame cuantos amigos tienes. "))
print()
#quinta interacción. Número de celular
num_cel=int(input("Cuentame cual es tu numero de celular: "))
print()
#sexta interacción. Genero
genero=input("Dime tu genero: ")
print()
#septima interacción.Ciudad donde vive
ciudad=input("Dime la ciudad en donde vives: ")
